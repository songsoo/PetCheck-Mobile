            ...
            public void onClick(View v) {
                ...
                if (isOnceStart == true) {
                    if (totalDistance < 1000) {
                        Toast.makeText(mContext,"산책 거리가 너무 짧습니다",Toast.LENGTH_SHORT).show();
                        totalDistance=0;
                        timerTime=0;
                ...
                oDialog.setTitle("종류를 선택하세요")
                        .setItems(oItems, new DialogInterface.OnClickListener()
                        {
                            ...
                            public void onClick(DialogInterface dialog, int which)
                            {
                               switch (which){
                                   case 0:
                                       BitmapDrawable bd = (BitmapDrawable) ContextCompat.getDrawable(getActivity(),R.drawable.baseline_delete_black_48);
                                       ...
                                       break;
                                   case 1:
                                       BitmapDrawable bd2 = (BitmapDrawable) ContextCompat.getDrawable(getActivity(),R.drawable.baseline_warning_black_48);
...
//                            mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(startLatLng, 18));
                            ...
                            Toast.makeText(getContext(), "루트 읽기 실패", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
